...
def process_task(task_id, callback_url, video_path, t0, in_audio):
    try:
...
def requset_heygem(task_id, result, in_audio,callback_url):
        ...
        data = {
                    ...
                    "data_url": result,  # 主视频
                    "audio_url": in_audio,
                    # "audio_url":"https://qscloudhongqi.wengegroup.com/bucket-yoya/2025/06/10/68479857se4b08b27c29f3f48/十四届全国人大三次会议举行第二次全体会议.mp3",
                }    
        url = 'http://10.20.4.7:22533/analysis'
