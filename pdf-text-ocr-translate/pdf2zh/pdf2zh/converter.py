...
class TranslateConverter(PDFConverterEx):
    def __init__(
        ...
        if not envs:
            envs = {}
        for translator in [GoogleTranslator, BingTranslator, DeepLTranslator, DeepLXTranslator, OllamaTranslator, XinferenceTranslator, AzureOpenAITranslator, YiWengeTranslator,
